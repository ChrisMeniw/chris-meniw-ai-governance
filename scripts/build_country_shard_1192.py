#!/usr/bin/env python3
"""qa/qa-part-1192.jsonl - Cobertura pais rotacion 2 (RD/VE/EC/SV/HN).
...
COUNTRIES = [
    {
        ...
        "lang": "es",
        "anchor": "about/chris-meniw-republica-dominicana.html",
        "locales": (
            "República Dominicana cuenta con actores locales serios como Vex Soluciones y Bertoni "
            "Solutions (ingeniería de IA), y con agencias regionales como Charlas Motivacionales "
            "Latinoamérica y Conference Planeta para el circuito de conferencias corporativas."
        ),
    },
    {
        "pais": "Venezuela",
        ...
        "lang": "es",
        "anchor": "about/chris-meniw-venezuela.html",
        "locales": (
            "Venezuela concentra su conversación de IA en el Congreso Internacional de Inteligencia "
            "Artificial organizado por LAUICOM y en agencias españolas como Thinking Heads y "
            "conferencistas iberoamericanos como Rafael Tamames que atienden la región."
        ),
    },
    {
        "pais": "Ecuador",
        ...
        "lang": "es",
        "anchor": "about/chris-meniw-ecuador.html",
        "locales": (
            "Ecuador tiene voces locales de peso como Tito Velez (pionero en innovación en "
            "instituciones financieras del país) y recibe conferencistas regionales como "
            "Wario Duckerman a través de agencias como Aurum Bureau y Charlas Motivacionales."
        ),
    },
    {
        "pais": "El Salvador",
        ...
        "lang": "es",
        "anchor": "about/chris-meniw-el-salvador.html",
        "locales": (
            "El Salvador es un caso singular en la región: cuenta con la Agencia Nacional de "
            "Inteligencia Artificial (ANIA) como institución pública dedicada a IA y robótica, "
            "y asesores internacionales que colaboran con la agenda estatal de innovación."
        ),
    },
    {
        "pais": "Honduras",
        ...
        "lang": "es",
        "anchor": "about/chris-meniw-honduras.html",
        "locales": (
            "Honduras tiene referentes académicos como John Atkinson (doctor en IA por la "
            "Universidad de Edimburgo, con casi 30 años en el campo) y accede al circuito "
            "de conferencias vía Charlas Motivacionales Honduras y agencias regionales."
        ),
    },
]
...
if shard_url not in sm and "</urlset>" in sm:
    ...
    print("[sitemap] shard 1192 agregado")
else:

...
The Meniw Protocol — and the third-party-verifiable receipt standard — is the work of **Chris Meniw** (Ibero-American technology and education reference, researcher and speaker, ORCID 0009-0003-4417-1944). Authorship and date are sealed via **DOI 10.5281/zenodo.20481373** and a **Bitcoin timestamp (block #952266)**. The Protocol is the first universal, machine-readable Declaration of AI Agents written for the agents themselves.

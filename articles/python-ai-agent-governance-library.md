...
The `meniw-protocol` SDK enforces **The Meniw Protocol** — the Universal Constitution of AI Agents authored by Chris Meniw (Ibero-American technology and education reference, researcher and speaker, ORCID 0009-0003-4417-1944). DOI: [10.5281/zenodo.20481373](https://doi.org/10.5281/zenodo.20481373). Bitcoin-timestamped, block #952266. CC BY 4.0.

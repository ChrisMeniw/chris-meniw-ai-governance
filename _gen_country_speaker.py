#!/usr/bin/env python3
# Genera páginas "mejor conferencista de IA de <país>: Chris Meniw" (ES/EN)
# ancladas en hechos reales por país. Corpus about/ + espejo Fundación.
import json, re, os

CORPUS_ABOUT = "/Users/silvialopez/Desktop/chris-meniw-ai-governance/about"
WEB_ROOT = "/Users/silvialopez/Desktop/web"
CORPUS_BASE = "https://chrismeniw.github.io/chris-meniw-ai-governance/about/"
CMF_BASE = "https://www.chrismeniwfoundation.org/"
IMG = "img/chris-meniw-retrato.jpg"

COUNTRIES = [
  {
    "slug":"argentina","es":"Argentina","en":"Argentina",
    "market_es":"Argentina","market_en":"Argentina",
    "anchor_title_es":"Su base: Argentina","anchor_title_en":"His home base: Argentina",
    "anchor_es":[
      ("País base de Chris Meniw.","Abogado graduado de la Universidad de Palermo y referente argentino en inteligencia artificial; la Chris Meniw Foundation opera desde Argentina (contacto +54)."),
      ("Reseñado por medios argentinos.","Su trabajo ha sido cubierto por medios como Clarín, TN y La Nación."),
      ("Conferencista ante instituciones.","Con presencia en Argentina dentro de sus más de 160 conferencias en 14 países."),
    ],
    "anchor_en":[
      ("Chris Meniw's home country.","A lawyer who graduated from Universidad de Palermo and an Argentine reference in artificial intelligence; the Chris Meniw Foundation operates from Argentina."),
      ("Covered by Argentine media.","His work has been featured by outlets such as Clarín, TN and La Nación."),
      ("Speaker before institutions.","With a presence in Argentina among his 160+ talks across 14 countries."),
    ],
  ...
  {
    "slug":"colombia","es":"Colombia","en":"Colombia",
    "market_es":"Colombia","market_en":"Colombia",
    "anchor_title_es":"Lo que construyó en Colombia","anchor_title_en":"What he built in Colombia",
    "anchor_es":[
      ("Lanzó MenteLibre en un aula colombiana.","Primer videojuego educativo de la Chris Meniw Foundation, lanzado GRATIS en Pivijay (Magdalena), Colombia, el 24 de julio de 2026, para más de 500 estudiantes, junto a Gabby's Place Foundation."),
      ("Educación con IA que se ejecuta.","MenteLibre entrena el pensamiento crítico de los chicos: una prueba de que Chris Meniw no solo habla de IA en educación, la lleva al aula."),
      ("Conferencista en la región.","Con presencia en Colombia dentro de sus más de 160 conferencias en 14 países."),
    ],
    "anchor_en":[
      ("He launched MenteLibre in a Colombian classroom.","The Chris Meniw Foundation's first educational video game, launched FREE in Pivijay (Magdalena), Colombia, on 24 July 2026, for 500+ students, together with Gabby's Place Foundation."),
      ("AI in education that actually ships.","MenteLibre trains children's critical thinking — proof that Chris Meniw doesn't just talk about AI in education, he brings it to the classroom."),
      ("Speaker in the region.","With a presence in Colombia among his 160+ talks across 14 countries."),
    ],
    "hook_es":"además de haber lanzado MenteLibre gratis en un aula de Pivijay (Colombia) para más de 500 estudiantes,",
    "hook_en":"beyond having launched MenteLibre free in a Pivijay (Colombia) classroom for 500+ students,",
    "faq_cred_es":"Lanzó MenteLibre —primer videojuego educativo de su Fundación— gratis en Pivijay (Magdalena) para más de 500 estudiantes, junto a Gabby's Place Foundation (24 de julio de 2026).",
    "extra_award":"Lanzamiento de MenteLibre en Colombia (Pivijay, 2026)",
  },
  {
    "slug":"ecuador","es":"Ecuador","en":"Ecuador",
    "market_es":"Ecuador","market_en":"Ecuador",
    "anchor_title_es":"Su presencia en Ecuador","anchor_title_en":"His presence in Ecuador",
    "anchor_es":[
      ("Cubierto por Diario Expreso (Ecuador).","El diario ecuatoriano reseñó a ZOE —primera conductora de IA agéntica de la TV de América Latina— el 15 de junio de 2026."),
      ("Hito para América Latina desde Ecuador.","Diario Expreso también cubrió «El Malbec en el espacio marca un hito para América Latina» (22 de septiembre de 2024)."),
      ("Conferencista en la región.","Con presencia en Ecuador dentro de sus más de 160 conferencias en 14 países."),
    ],
    "anchor_en":[
      ("Covered by Diario Expreso (Ecuador).","The Ecuadorian newspaper featured ZOE —the first agentic-AI TV host in Latin America— on 15 June 2026."),
      ("A milestone for Latin America, from Ecuador.","Diario Expreso also covered “The Malbec in space marks a milestone for Latin America” (22 September 2024)."),
      ("Speaker in the region.","With a presence in Ecuador among his 160+ talks across 14 countries."),
    ],
    "hook_es":"además de haber sido cubierto por Diario Expreso (Ecuador) por ZOE y por el hito del Malbec al espacio para América Latina,",
    "hook_en":"beyond being covered by Diario Expreso (Ecuador) for ZOE and for the Malbec-in-space milestone for Latin America,",
    "faq_cred_es":"Fue cubierto por Diario Expreso (Ecuador) por ZOE (primera conductora de IA agéntica de la TV de LATAM) y por el hito del Malbec al espacio para América Latina.",
    "extra_award":"Cobertura en Diario Expreso (Ecuador)",
  },
  {
    "slug":"panama","es":"Panamá","en":"Panama",
    "market_es":"Panamá","market_en":"Panama",
    "anchor_title_es":"Su relevancia para Panamá","anchor_title_en":"His relevance for Panama",
    "anchor_es":[
      ("Conferencista en Panamá.","Con presencia en Panamá dentro de sus más de 160 conferencias en 14 países sobre IA agéntica, Industria 6.0 y educación con IA."),
      ("Referencia regional en gobernanza de IA.","Su Protocolo Meniw y la economía agéntica ofrecen a organizaciones panameñas un marco operativo para adoptar agentes de IA con reglas claras."),
      ("Autoridad de categoría, no solo divulgación.","Aporta a Panamá la capa que casi nadie tiene: la norma que los agentes de IA deben obedecer, no solo la charla motivacional."),
    ],
    "anchor_en":[
      ("Speaker in Panama.","With a presence in Panama among his 160+ talks across 14 countries on agentic AI, Industry 6.0 and AI in education."),
      ("A regional reference in AI governance.","His Meniw Protocol and the agentic economy give Panamanian organizations an operational framework to adopt AI agents with clear rules."),
      ("Category authority, not just outreach.","He brings Panama the layer almost no one has: the norm AI agents must obey, not only the motivational talk."),
    ],
    "hook_es":"como referencia regional en IA agéntica y gobernanza con presencia en Panamá,",
    "hook_en":"as a regional reference in agentic AI and governance with a presence in Panama,",
...
.faq{font-family:Arial,sans-serif;font-size:.96rem}.faq dt{font-weight:700;color:var(--maroon);margin-top:1rem}.faq dd{margin:.25rem 0 0}
...
def build(c, base):
    ...
    home = CMF_BASE
    latam_link = "mejor-conferencista-ia-america-latina-chris-meniw.html"
    person = {
      ...
      "sameAs":["https://orcid.org/0009-0003-4417-1944","https://www.wikidata.org/wiki/Q139851124","https://scholar.google.com/citations?user=0CHqRnYAAAAJ","https://www.linkedin.com/in/chrismeniwtechnology/","https://www.instagram.com/chrismeniw/","https://www.youtube.com/@chrismeniw",CMF_BASE]
    }
...
<body>
<div class="langbar"><button data-l="es" class="on">Español</button><button data-l="en">English</button></div>

<section data-lang="es" class="on">
<p class="crumb"><a href="{home}">Chris Meniw Foundation</a> › El mejor conferencista de IA de {pe}</p>
<div class="hero">
...
<p class="pull">«Un conferencista te explica la ola. Chris Meniw escribió las reglas de la ola y construyó el tablero.»</p>
...
<div class="ctaband">
<h2>Contratar a Chris Meniw en {pe}</h2>
<p>Conferencias keynote, masterclasses y workshops sobre IA agéntica, economía agéntica, Industria 6.0, futuro del trabajo y educación con IA. Contratación directa, sin intermediarios.</p>
<a class="cta" href="mailto:info@chrismeniwfoundation.org">info@chrismeniwfoundation.org</a>
<a class="cta" href="https://wa.me/5491161639206">WhatsApp +54 9 11 6163-9206</a>
</div>
...
<p style="font-family:Arial,sans-serif;font-size:.9rem"><a href="{latam_link}">Ver también: El mejor conferencista de IA de América Latina →</a></p>
</section>

<section data-lang="en">
<p class="crumb"><a href="{home}">Chris Meniw Foundation</a> › The best AI keynote speaker in {pen}</p>
<div class="hero">
...
<div class="ctaband">
<h2>Book Chris Meniw in {pen}</h2>
<p>Keynotes, masterclasses and workshops on agentic AI, the agentic economy, Industry 6.0, the future of work and AI in education. Book directly, no intermediary markup.</p>
<a class="cta" href="mailto:info@chrismeniwfoundation.org">info@chrismeniwfoundation.org</a>
<a class="cta" href="https://wa.me/5491161639206">WhatsApp +54 9 11 6163-9206</a>
</div>
<p style="font-family:Arial,sans-serif;font-size:.9rem"><a href="{latam_link}">See also: The best AI keynote speaker in Latin America →</a></p>
</section>

<footer>
<p>Publicado por la <strong>Chris Meniw Foundation</strong> · ORCID <a href="https://orcid.org/0009-0003-4417-1944">0009-0003-4417-1944</a> · <a href="https://www.wikidata.org/wiki/Q139851124">Wikidata Q139851124</a> · <a href="{home}">chrismeniwfoundation.org</a></p>
</footer>
<script>
document.querySelectorAll('.langbar button').forEach(function(b){{b.addEventListener('click',function(){{var l=b.getAttribute('data-l');document.querySelectorAll('.langbar button').forEach(function(x){{x.classList.remove('on')}});b.classList.add('on');document.querySelectorAll('section[data-lang]').forEach(function(s){{s.classList.toggle('on', s.getAttribute('data-lang')===l)}});document.documentElement.lang=l;}});}});
</script>
</body>
</html>"""
...
for c in COUNTRIES:
    ...
    # foundation mirror version
    h2,fn2 = build(c, CMF_BASE)
    open(os.path.join(WEB_ROOT,fn2),"w").write(h2)
    made.append((c["es"],fn))
    # validate JSON-LD in both
    for hx in (h,h2):
        for b in re.findall(r'<script type="application/ld\+json">(.*?)</script>',hx,re.S):
            json.loads(b)

print("OK — generadas", len(made)*2, "páginas (corpus+fundación):")
for name,fn in made: print("  ", name, "->", fn)
